<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="ViewInventory.aspx.cs" Inherits="Admin_ViewInventory" %>
                ...
                <div class="box-content">
                               <div class="row">
                                          ...
                                          <div class="col-sm-12" runat="server" id="divList">
                                           ...
                                           <asp:GridView ID="grdInventory" ShowHeaderWhenEmpty="true"  EmptyDataRowStyle-CssClass="text-center" EmptyDataText="No record to display" CssClass="table table-condensed table-responsive table-hover table-striped table-bordered medium-font" AutoGenerateColumns="False" runat="server" >
                                                  <Columns>
                                                      ...
                                                      <asp:BoundField DataField="Stock.Name" HeaderText=" Stock Name" />
                                                       <asp:BoundField DataField="CostPrice" HeaderText=" Cost Price" />
                                                      <asp:BoundField DataField="Quantity" HeaderText="Quantity" />
                                                      <asp:BoundField DataField="DateCreated" HeaderText=" Date Created" />
                                                      <asp:BoundField DataField="ReorderLevel" HeaderText="Reorder Level" />
                                                      <asp:BoundField DataField="Permision" HeaderText="Permission" />
                                                        ...
                                                        <ItemTemplate>
                                                            <table>
                                                                <tr>
                                                                      ...
                                                                      <td>
                                                                        <asp:LinkButton ID="btnEdit" CommandArgument='<%#Eval("InventoryId") %>'  ClientIDMode="Static" CausesValidation="False"   OnClick="btnEdit_Click" CssClass="btn btn-xs btn-primary" runat="server"><i class="fa fa-edit"></i>Edit</asp:LinkButton> 
                                                                    </td>
                                                                      <td>
                                                                        <asp:LinkButton ID="btnView" CommandArgument='<%#Eval("InventoryId") %>'  ClientIDMode="Static" CausesValidation="False" OnClick="btnView_Click" CssClass="btn btn-xs btn-info" runat="server"><i class="fa fa-edit"></i>View</asp:LinkButton> 
                                                                    </td>
                                                                    <td>
                                                            
                                                              <asp:LinkButton ID="btnDelete"  OnClick="btnDelete_Click" CommandArgument='<%#Eval("InventoryId") %>'   OnClientClick="javascript:return confirm('Are you sure you want to delete this Inventory from the list?');" AlternateText="Delete Inventory" CssClass="btn btn-xs btn-danger" runat="server"><i class="fa fa-trash-o"></i> Delete</asp:LinkButton> 
